...
test.describe('Produk Carousels', () => {
  test('renders laptop and accessory products as non-autoplay carousels with catalog image links', async ({ page }) => {
    ...
    await expect(laptopCarousel).toHaveAttribute('data-carousel-autoplay', 'false');
    ...
    await expect(laptopLink).toHaveAttribute('href', 'https://wa.me/c/6288980042670');
    ...
    await expect(aksesoriCarousel).toHaveAttribute('data-carousel-autoplay', 'false');
    ...
    await expect(aksesoriLink).toHaveAttribute('href', 'https://wa.me/c/6288980042670');
    ...
    await expect(laptopChatBtn).toHaveAttribute('href', /wa\.me\/6288980042670/);
    ...
    await expect(aksesoriChatBtn).toHaveAttribute('href', /wa\.me\/6288980042670/);
  });

  test('hides floating WhatsApp button on mobile product page', async ({ page }) => {
  ...
  test('provides no-JS fallback with static items and category anchors', async ({ browser }) => {
